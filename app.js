...
function hideAllPages(){
  ...
  ['home-view','pass-view','report-view','dashboard-view','reports-view','order-view','stocktake-view','recipes-view','check-view','scheduling-view','closing-view','team-view','content','legend-bar','sec-counter-wrap','add-section-wrap'].forEach(function(id){
